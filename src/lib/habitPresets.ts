...
export const HABIT_PRESETS: Record<GoalCode, PresetHabit[]> = {
  fit: [
    ...
    { name: "Exercise – 10 minutes of stretching" },
    { name: "Exercise – Strength session" },
    { name: "Sleep – Go to bed on time" },
    { name: "Eating – Cook your meal" },
  ...
  job: [
    ...
    { name: "Job – Message someone in your field" },
    { name: "Job – Update your portfolio" },
    { name: "Job – Practise one interview answer" },
    { name: "Learning – 30 minutes of study" },
  ...
  connect: [
    ...
    { name: "Connect – Start a conversation with someone new" },
